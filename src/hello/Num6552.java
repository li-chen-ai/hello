...
//    	}
    ...
    public static List<List<String>> full(TreeNode root, List<List<String>> tree, int level, int begin, int end)
    {
    	if(root!=null)
    	{
    		tree.get(level).set((begin+end)/2, ""+root.val);
